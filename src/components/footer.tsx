...
export function Footer() {
  return (
    <footer className="px-4 sm:px-6 pb-4 sm:pb-6">
      <div className="mx-auto max-w-6xl rounded-2xl bg-white/80 backdrop-blur-xl ring-1 ring-gray-200/60 shadow-[0_8px_30px_rgba(0,0,0,0.04)] px-5 sm:px-7 py-4 sm:py-5">
