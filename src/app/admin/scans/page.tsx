                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {r.user && (
                        <Link
                          ...
                          className="mt-3 -mx-1 flex items-center gap-3 px-3 py-2.5 rounded-xl ring-1 ring-gray-100 hover:ring-orange-200 bg-white/50 hover:bg-orange-50/40 transition-all duration-200 group"
                        >
                          <div className="flex-1 min-w-0">
                            <p className="text-[13px] font-medium text-gray-900 truncate group-hover:text-orange-700 transition-colors">
                          ...
                          <ChevronRight className="w-3.5 h-3.5 text-gray-300 group-hover:text-orange-500 group-hover:translate-x-0.5 transition-all shrink-0" />
                        </Link>
                      )}
                    </div>
                  </div>
