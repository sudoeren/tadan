      ...
      <div className="flex-1 flex flex-col justify-center px-5 sm:px-10 py-12 max-w-xl mx-auto w-full">
        ...
        <div className="animate-fade-up">
          ...
          <p className="text-gray-500 text-base mt-3 leading-relaxed">
            50 free scans per month. No credit card. No banned accounts.
          </p>
        </div>
        ...
        <ul className="animate-fade-up [animation-delay:200ms] mt-6 space-y-1.5">
          {[
            "50 free scans every month",
            "Meta, Google, and Taboola policies",
            "RAG over 1,200+ policy rules",
            "Hook-preserving safe rewrites",
          ].map((benefit) => (
            <li
              key={benefit}
        ...
        <p className="animate-fade-up [animation-delay:280ms] mt-6 text-[13px] text-gray-500">
