            ...
            {step === "form" ? (
              <>
                ...
                >
                  <div className="sm:col-span-1">
                    <label
                      htmlFor="name"
                      className="block text-[12px] font-medium text-gray-700 mb-1 ml-1"
                    >
                      Name
                    </label>
                    <input
              ...
              <>
                <button
                  ...
                  className="inline-flex items-center gap-1.5 text-[12px] text-gray-500 hover:text-gray-900 transition-colors mb-4"
                >
                ...
                <div className="mt-5 text-center text-[12px] text-gray-500">
                  ...
                  <button
                    ...
                    className="text-orange-600 hover:text-orange-700 font-semibold disabled:text-gray-400 disabled:cursor-not-allowed transition-colors"
                  >
                    {resendCooldown > 0
