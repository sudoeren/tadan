                ...
                {PLATFORMS.map((p) => {
                  ...
                  return (
                    <button
                      ...
                      className={`group flex items-center gap-2.5 text-[13px] font-medium pl-1.5 pr-3.5 py-1.5 rounded-xl border-2 transition-all ${
                        on
                          ? `${p.tint.bg} ${p.tint.border} ${p.tint.text} shadow-sm`
